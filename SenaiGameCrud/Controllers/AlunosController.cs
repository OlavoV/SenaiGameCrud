...
namespace SenaiGameCrud.Controllers
{
    public class AlunosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdAluno,Nome,Idade,Modalidade,Matricula")] Aluno aluno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAluno,Nome,Idade,Modalidade,Matricula")] Aluno aluno)
        {
            if (id != aluno.IdAluno)
            {
                return NotFound();
